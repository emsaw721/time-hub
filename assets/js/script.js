...
// localStorage.setItem("#9", JSON.stringify(time9));
...
$("#hour-text").click(function(event) {
    var $editText = document.getElementById("hour-text");
    var $userText = editText.innerHTML;
    $(this).html($userText); 
